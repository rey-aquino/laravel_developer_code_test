...
<div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="m-b-0 m-t-0">Add Customers</h3>
            <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Customer Form</h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('add-customers.store') }}" class="form-horizontal">
                        @csrf
                        <div class="form-body">
